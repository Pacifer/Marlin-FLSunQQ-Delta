...
#define STRING_CONFIG_H_AUTHOR "(K.Albrecht, FLSUN-QQ)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_ENDSTOP_ADJ { 0.0, -1.84, -1.55 } // get these from auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { 0.26, -0.37, 0.12 } // get these values from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 87.7 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2600, 2600, 2600, 6000 }
...
#define DEFAULT_TRAVEL_ACCELERATION   2600    // X, Y, Z acceleration for travel (non printing) moves
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 2.5)
